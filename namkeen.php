...
<div style="background:transparent !important"class="jumbotron">
  <div class="container text-center">
    <h1 align="center">Namkeen</h1>

   
  </div>
</div>';
 $sql="select item_id,item_name,type,image,quantity,price from items where type like 'namkeen'";
  ...
  while($row=mysqli_fetch_array($result)){
		...
		$count2=$count;
         ...
         <div class="panel-heading">',$item_name.'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRs.'.$price,'</div>		 
