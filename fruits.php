...
<div style="background:transparent !important"class="jumbotron">
 ...
 $sql="select item_id,item_name,type,image,quantity,price from items where type like 'fruit'";
  ...
  while($row=mysqli_fetch_array($result)){
		...
		$count2=$count;
         ...
         <div class="panel-heading">',$item_name.'&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRs.'.$price,'</div>		 
